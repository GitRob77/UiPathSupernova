...
import type { TreeViewItem } from "@uipath/apollo-wind";
import {
  Folders,
  Briefcase,
  SquareActivity,
...
const MAX_DEMO_PROJECTS: TreeViewItem[] = [
  {
    id: "agent",
    name: "Agent",
    type: "agent",
    children: [
      ...
      { id: "agent-eval-sets", name: "Evaluation Sets", type: "evaluation-sets" },
...
export default function MaxDemoPage() {
  ...
  /* --- Panels --- */
  const explorer = useExplorerPanel({
    solutionName: "MaxDemo",
    projects: MAX_DEMO_PROJECTS,
